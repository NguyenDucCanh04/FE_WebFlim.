	...
	<div class="topbar d-flex align-items-center">
		<nav class="navbar navbar-expand">
			<div class="topbar-logo-header">
				...
				<div class="">
					<h4 class="logo-text">PHIM MỚI </h4>
				</div>
			</div>
			<div class="mobile-toggle-menu"><i class='bx bx-menu'></i></div>
			<div class="search-bar flex-grow-1">
				<div class="position-relative search-bar-box">
					<input v-model="noi_dung_tim" @keyup.enter="timKiem" type="text" class="form-control search-control" placeholder="Tìm Kiếm?">
					<span class="position-absolute top-50 search-show translate-middle-y" @click="timKiem"><i
			...
			<div class="user-box dropdown">
				<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
					...
					<div class="user-info ps-3">
						  <p class="user-name mb-0">{{ name_nv }}</p>
						<p class="designation mb-0 fw-bold">Admin</p>
					</div>
				</a>
...
export default {
  data() {
        return {
            noi_dung_tim: '',
            auth: false,
            name_nv: localStorage.getItem('ten_nv') || '',
        }
	...
	methods: {
        ...
        timKiem() {
            if (!this.noi_dung_tim || this.noi_dung_tim.trim() === '') return;
            this.$router.push({
                name: 'name_tim_kiem',
                params: {
